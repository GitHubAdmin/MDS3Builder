class GG0170a3
  ...
  def initialize
    @name = "Mobility - Roll left and right (Discharge Performance) - The ability to roll from lying on back to left and right side, and return to lying on back on the bed. (GG0170a3)"
    @field_type = DROPDOWN
    @node = "GG0170A3" 
