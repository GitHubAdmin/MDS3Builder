class GG0130g5
  ...
  def initialize
    @name = "Self-Care - Lower body dressing (Interim Performance) - The ability to dress and undress below the waist, including fasteners; does not include footwear. (GG0130g5)"
    @field_type = DROPDOWN
    @node = "GG0130G5" 
