class GG0130h5
  ...
  def initialize
    @name = "Self-Care - Putting on/taking off footwear (Interim Performance) - The ability to put on and take off socks and shoes or other footwear that is appropriate for safe mobility; including fasteners, if applicable. (GG0130h5)"
    @field_type = DROPDOWN
    @node = "GG0130H5" 
