class GG0170c3
  ...
  def initialize
    @name = "Mobility - Lying to sitting on side of bed (Discharge Performance) - The ability to move from lying on the back to sitting on the side of the bed with feet flat on the floor, and with no back support. (GG0170c3)"
    @field_type = DROPDOWN
    @node = "GG0170C3" 
