...
include AssessmentHelper
  ...
  def initialize
    ...
    @options << FieldOption.new("0", key: "I5800", excluded_assmnt_types: ["ND"])
    @options << FieldOption.new("1", "Depression (other than bipolar) (I5800)", key: "I5800", excluded_assmnt_types: ["ND"])
