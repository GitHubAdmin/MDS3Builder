class I0200_I0900
  ...
  def initialize
    ...
    @options << FieldOption.new("0", key: "I0300")
    @options << FieldOption.new("1", "Atrial Fibrillation or Other Dysrhythmias (e.g., bradycardias and tachycardias) (I0300)", key: "I0300")
    ...
    @options << FieldOption.new("0", key: "I0500")
    @options << FieldOption.new("1", "Deep Venous Thrombosis (DVT), Pulmonary Embolus (PE), or Pulmonary Thrombo-Embolism (PTE) (I0500)", key: "I0500")
