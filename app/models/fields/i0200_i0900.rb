...
include AssessmentHelper
  ...
  def set_options_for_type(klass)
    ...
    @options << FieldOption.new("0", key: "I0300") if ! ["NQ","NP"].include?(assmnt_type)
    @options << FieldOption.new("1", "Atrial Fibrillation or Other Dysrhythmias (e.g., bradycardias and tachycardias) (I0300)", key: "I0300") if ! ["NQ","NP"].include?(assmnt_type)
    ...
    @options << FieldOption.new("0", key: "I0500") if ! ["NQ","NP"].include?(assmnt_type)
    @options << FieldOption.new("1", "Deep Venous Thrombosis (DVT), Pulmonary Embolus (PE), or Pulmonary Thrombo-Embolism (PTE) (I0500)", key: "I0500") if ! ["NQ","NP"].include?(assmnt_type)
