class GG0130h2
  ...
  def initialize
    @name = "Self-Care - Putting on/taking off footwear (Discharge Goal) - The ability to put on and take off socks and shoes or other footwear that is appropriate for safe mobility; including fasteners, if applicable. (GG0130h2)"
    @field_type = DROPDOWN
    @node = "GG0130H2" 
