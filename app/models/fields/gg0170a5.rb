class GG0170a5
  ...
  def initialize
    @name = "Mobility - Roll left and right (Interim Performance) - The ability to roll from lying on back to left and right side, and return to lying on back on the bed. (GG0170a5)"
    @field_type = DROPDOWN
    @node = "GG0170A5" 
