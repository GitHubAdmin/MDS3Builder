class GG0170r1
  ...
  def initialize
    @name = "Mobility - Wheel 50 feet with two turns (Admission Performance) - Once seated in wheelchair/scooter, the ability to wheel at least 50 feet and make two turns. (GG0170r1)"
    @field_type = DROPDOWN
    @node = "GG0170R1" 
