class GG0170a1
  ...
  def initialize
    @name = "Mobility - Roll left and right (Admission Performance) -  The ability to roll from lying on back to left and right side, and return to lying on back on the bed. (GG0170a1)"
    @field_type = DROPDOWN
    @node = "GG0170A1" 
