class D0150i2
  ...
  def initialize
    @name = "Resident Mood Interview: Over last two weeks, how often has resident reported thoughts that they would be better off dead, or of hurting themself in some way? (D0150i2)"
    @field_type = DROPDOWN
    @node = "D0150I2" 
