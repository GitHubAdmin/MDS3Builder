class GG0170g3
  ...
  def initialize
    @name = "Mobility - Car transfer (Discharge Performance) - The ability to transfer in and out of a car or van on the passenger side. Does not include the ability to open/close door or fasten seat belt. (GG0170g3)"
    @field_type = DROPDOWN
    @node = "GG0170G3" 
