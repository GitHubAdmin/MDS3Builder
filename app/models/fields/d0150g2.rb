class D0150g2
  ...
  def initialize
    @name = "Resident Mood Interview: Over last two weeks, how often has resident reported having trouble concentrating on things, such as reading the newspaper or watching television? (D0150g2)"
    @field_type = DROPDOWN
    @node = "D0150G2" 
