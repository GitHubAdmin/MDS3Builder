class GG0170d5
  ...
  def initialize
    @name = "Mobility - Sit to stand (Interim Performance) - The ability to safely come to a standing position from sitting in a chair, wheelchair, or on the side of the bed. (GG0170d5)"
    @field_type = DROPDOWN
    @node = "GG0170D5" 
