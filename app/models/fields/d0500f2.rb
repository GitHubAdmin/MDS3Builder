class D0500f2
  ...
  def initialize
    @name = "Staff Assessment of Resident Mood: Over last two weeks, how often has resident indicated that they feel bad about self, are a failure, or have let self or family down? (D0500f2)"
    @field_type = DROPDOWN
    @node = "D0500F2" 
