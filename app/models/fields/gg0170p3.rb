class GG0170p3
  ...
  def initialize
    @name = "Mobility - Picking up object (Discharge Performance) - The ability to bend/stoop from a standing position to pick up a small object, such as a spoon, from the floor. (GG0170p3)"
    @field_type = DROPDOWN
    @node = "GG0170P3" 
