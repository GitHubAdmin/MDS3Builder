class GG0170r5
  ...
  def initialize
    @name = "Mobility - Wheel 50 feet with two turns (Interim Performance) - Once seated in wheelchair/scooter, the ability to wheel at least 50 feet and make two turns. (GG0170r5)"
    @field_type = DROPDOWN
    @node = "GG0170R5" 
