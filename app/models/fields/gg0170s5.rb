class GG0170s5
  ...
  def initialize
    @name = "Mobility - Wheel 150 feet (Interim Performance) - Once seated in wheelchair/scooter, the ability to wheel at least 150 feet in a corridor or similar space. (GG0170s5)"
    @field_type = DROPDOWN
    @node = "GG0170S5" 
