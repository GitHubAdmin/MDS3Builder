class I1700_I2500
  ...
  def initialize
    ...
    @options << FieldOption.new("0", key: "I2200")
    @options << FieldOption.new("1", "Tuberculosis (I2200)", key: "I2200")
    @options << FieldOption.new("0", key: "I2300")
    @options << FieldOption.new("1", "Urinary Tract Infection (UTI) (LAST 30 DAYS) (I2300)", key: "I2300")
    @options << FieldOption.new("0", key: "I2400")
    @options << FieldOption.new("1", "Viral Hepatitis (e.g., Hepatitis A, B, C, D, and E) (I2400)", key: "I2400")
