class GG0130e5
  ...
  def initialize
    @name = "Self-Care - Shower/bathe self (Interim Performance) - The ability to bathe self, including washing, rinsing, and drying self (excludes washing of back and hair). Does not include transferring in/out of tub/shower. (GG0130e5)"
    @field_type = DROPDOWN
    @node = "GG0130E5" 
