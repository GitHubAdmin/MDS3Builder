class GG0130h1
  ...
  def initialize
    @name = "Self-Care - Putting on/taking off footwear (Admission Performance) - The ability to put on and take off socks and shoes or other footwear that is appropriate for safe mobility; including fasteners, if applicable. (GG0130h1)"
    @field_type = DROPDOWN
    @node = "GG0130H1" 
