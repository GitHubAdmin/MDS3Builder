class O0110a_O0110b
  ...
  def initialize
    ...
    @name = "Cancer Treatments (Check all of the following treatments, procedures, and programs that were performed) (O0100a - O0110b)"
    @field_type = CHECKBOX
    @node = "O0110A_O0110B" 
    ...
    @options << FieldOption.new("1", "Chemotherapy (Any) - While a Resident (O0110a1b)", key: "O0110A1B")
    # @options << FieldOption.new("0", key: "O0110A1C")
    # @options << FieldOption.new("1", "Chemotherapy (Any) - At Discharge (O0110a1c)", key: "O0110A1C")
    # @options << FieldOption.new("0", key: "O0110A2A")
    # @options << FieldOption.new("1", "Chemotherapy (IV) - On Admission (O0110a2a)", key: "O0110A2A")
    # @options << FieldOption.new("0", key: "O0110A2C")
    # @options << FieldOption.new("1", "Chemotherapy (IV) - At Discharge (O0110a2c)", key: "O0110A2C")
    # @options << FieldOption.new("0", key: "O0110A3A")
    # @options << FieldOption.new("1", "Chemotherapy (Oral) - On Admission (O0110a3a)", key: "O0110A3A")
    # @options << FieldOption.new("0", key: "O0110A3C")
    # @options << FieldOption.new("1", "Chemotherapy (Oral) - At Discharge (O0110a3c)", key: "O0110A3C")
    # @options << FieldOption.new("0", key: "O0110B1A")
    # @options << FieldOption.new("1", "Radiation (Any) - On Admission (O0110b1a)", key: "O0110B1A")
    @options << FieldOption.new("0", key: "O0110B1B")
    @options << FieldOption.new("1", "Radiation (Any) - While a Resident (O0110b1b)", key: "O0110B1B")
