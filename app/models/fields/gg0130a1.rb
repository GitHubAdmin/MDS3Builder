class GG0130a1
  ...
  def initialize
    @title = "Section GG - Functional Abilities and Goals - Admission"
    @name = "Self-Care - Eating (Admission Performance) - The ability to use suitable utensils to bring food and/or liquid to the mouth and swallow food and/or liquid once the meal is placed before the resident. (GG0130a1)"
    @field_type = DROPDOWN
    @node = "GG0130A1" 
