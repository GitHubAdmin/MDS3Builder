class GG0130g1
  ...
  def initialize
    @name = "Self-Care - Lower body dressing (Admission Performance) - The ability to dress and undress below the waist, including fasteners; does not include footwear. (GG0130g1)"
    @field_type = DROPDOWN
    @node = "GG0130G1" 
