class GG0130b1
  ...
  def initialize
    @name = "Self-Care - Oral Hygiene (Admission Performance) - The ability to use suitable items to clean teeth. Dentures (if applicable): The ability to insert and remove dentures into and from the mouth, and manage denture soaking and rinsing with use of equipment. (GG0130b1)"
    @field_type = DROPDOWN
    @node = "GG0130B1" 
