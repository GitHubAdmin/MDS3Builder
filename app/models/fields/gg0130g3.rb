class GG0130g3
  ...
  def initialize
    @name = "Self-Care - Lower body dressing (Discharge Performance) - The ability to dress and undress below the waist, including fasteners; does not include footwear. (GG0130g3)"
    @field_type = DROPDOWN
    @node = "GG0130G3" 
