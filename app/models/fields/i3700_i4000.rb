...
include AssessmentHelper
  ...
  def set_options_for_type(klass)
    ...
    if ! ["NQ","NP"].include?(assmnt_type)
      @options << FieldOption.new("0", key: "I3700")
      @options << FieldOption.new("1", "Arthritis (I3700)", key: "I3700")
      @options << FieldOption.new("0", key: "I3800")
      @options << FieldOption.new("1", "Osteoporosis (I3800)", key: "I3800")
    end
