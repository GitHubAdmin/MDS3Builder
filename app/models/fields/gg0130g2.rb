class GG0130g2
  ...
  def initialize
    @name = "Self-Care - Lower body dressing (Discharge Goal) - The ability to dress and undress below the waist, including fasteners; does not include footwear. (GG0130g2)"
    @field_type = DROPDOWN
    @node = "GG0130G2" 
