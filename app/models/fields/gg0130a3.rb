class GG0130a3
  ...
  def initialize
    ...
    @name = "Self-Care - Eating (Discharge Performance) - The ability to use suitable utensils to bring food and/or liquid to the mouth and swallow food and/or liquid once the meal is placed before the resident. (GG0130a3)"
    @field_type = DROPDOWN
    @node = "GG0130A3" 
