class GG0130i3
  ...
  def initialize
    @name = "Self-Care - Personal hygiene (Discharge Performance) - The ability to maintain personal hygiene, including combing hair, shaving, applying makeup, washing/ drying face and hands (excludes baths, showers, and oral hygiene). (GG0130i3)"
    @field_type = DROPDOWN
    @node = "GG0130I3" 
