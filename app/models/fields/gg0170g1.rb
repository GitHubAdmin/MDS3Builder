class GG0170g1
  ...
  def initialize
    @name = "Mobility - Car transfer (Admission Performance) - The ability to transfer in and out of a car or van on the passenger side. Does not include the ability to open/close door or fasten seat belt. (GG0170g1)"
    @field_type = DROPDOWN
    @node = "GG0170G1" 
