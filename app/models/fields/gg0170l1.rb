class GG0170l1
  ...
  def initialize
    @name = "Mobility - Walking 10 feet on uneven surfaces (Admission Performance) - The ability to walk 10 feet on uneven or sloping surfaces (indoor or outdoor), such as turf or gravel. (GG0170l1)"
    @field_type = DROPDOWN
    @node = "GG0170L1" 
