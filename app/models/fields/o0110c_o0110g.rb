class O0110c_O0110g
  ...
  def initialize
    @name = "Respiratory Treatments (Check all of the following treatments, procedures, and programs that were performed) (O0100c - O0110g)"
    @field_type = CHECKBOX
    @node = "O0110C_O0110G" 
    ...
    # @options << FieldOption.new("1", "Oxygen Therapy (Intermittent) - At Discharge (O0110c4a)", key: "O0110C3C")
    # @options << FieldOption.new("0", key: "O0110C4A")
    # @options << FieldOption.new("1", "Oxygen Therapy (High-concentration) - On Admission (O0110c4a)", key: "O0110C3A")
