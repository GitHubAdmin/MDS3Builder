class F0400h
  ...
  def initialize
    @name = "Interview for Daily Preferences: Ask resident: While you are in this facility, how important is it to you to have a place to lock your things to keep them safe? (F0400h)"
    @field_type = DROPDOWN
    @node = "F0400H"
