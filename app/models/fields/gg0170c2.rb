class GG0170c2
  ...
  def initialize
    @name = "Mobility - Lying to sitting on side of bed (Discharge Goal) - The ability to move from lying on the back to sitting on the side of the bed with feet flat on the floor, and with no back support. (GG0170c2)"
    @field_type = DROPDOWN
    @node = "GG0170C2" 
