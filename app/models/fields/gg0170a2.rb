class GG0170a2
  ...
  def initialize
    @name = "Mobility - Roll left and right (Discharge Goal) - The ability to roll from lying on back to left and right side, and return to lying on back on the bed. (GG0170a2)"
    @field_type = DROPDOWN
    @node = "GG0170A2" 
