class GG0130i5
  ...
  def initialize
    @name = "Self-Care - Personal hygiene (Interim Performance) - The ability to maintain personal hygiene, including combing hair, shaving, applying makeup, washing/ drying face and hands (excludes baths, showers, and oral hygiene). (GG0130i5)"
    @field_type = DROPDOWN
    @node = "GG0130I5" 
