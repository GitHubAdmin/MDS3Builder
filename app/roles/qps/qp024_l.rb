#--------------------------------------------------------
# QP024_l Prevalence of Stage 1-4, 
#         Pressure Ulcers (Low Risk)
#--------------------------------------------------------

module Qps::Qp024_l
  # TODO: Replace these "G" fields with something else eventually
  ...
  def apply_requested_qp_attributes(pos_or_neg, options = {})
    if pos_or_neg == "pos"
      # set_G0110A1_pos; set_G0110B1_pos; 
      set_M0210_pos;
    elsif pos_or_neg == "neg"
      # set_G0110A1_neg; set_G0110B1_neg; 
      set_M0210_neg;
    end
  end
